...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb]">
      ...
      <section className="mx-auto mt-8 w-full max-w-md px-4 pb-8 sm:mt-10">
        <form onSubmit={onLogin} className="overflow-hidden rounded-2xl border border-[#9fcfcd] bg-white shadow-[0_12px_30px_rgba(15,37,64,0.14)]">
          ...
          <div className="space-y-4 bg-[#f6fbfc] px-4 py-6 sm:px-6">
            <label className="block text-left text-sm font-semibold text-[#2f3a4d]">
              UAN
              <input
                name="uan"
                autoComplete="username"
                className="mt-1 w-full rounded-md border border-[#c8d2e0] bg-white px-3 py-3 text-base text-[#2d3b4f] outline-none focus:border-[#0e8e8e]"
            ...
            <button type="submit" className="min-h-11 w-full rounded-md bg-[#0e8a8a] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#0b7777]">
              Login
            </button>
          </div>
        </form>
